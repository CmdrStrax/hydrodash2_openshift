...
$my_a1 = get_col_station_watertemp($a1["val"], $a1["val_lt"], $a1["from"], $a1["to"]); 
$my_a2 = get_col_station_watertemp($a2["val"], $a2["val_lt"], $a2["from"], $a2["to"]); 
$my_a3 = get_col_station_watertemp($a3["val"], $a3["val_lt"], $a3["from"], $a3["to"]); 
$my_a4 = get_col_station_watertemp($a4["val"], $a4["val_lt"], $a4["from"], $a4["to"]); 
$my_a5 = get_col_station_watertemp($a5["val"], $a5["val_lt"], $a5["from"], $a5["to"]); 
$my_a6 = get_col_station_watertemp($a6["val"], $a6["val_lt"], $a6["from"], $a6["to"]); 
?>
...
<script>
  ...
  let ts;
  let chartdata = Array();
  var url = '<?php echo base_url();?>airtemp/chart/<?= esc($ds_id) ?>';
