...
<div class="container-fluid mt-3 mb-3">
  <table class="table table-hover nowrap" id="stations">
    ...
    <?php foreach ($ds as $d): ?>
    <?php 
      $a1 = get_col_table_watertemp($d['res_last_day_mean'], $d['res_last_day_mean_lt']);
      $a2 = get_col_table_watertemp($d['res_last_30days_mean'], $d['res_last_30days_mean_lt']);
      $a3 = get_col_table_watertemp($d['res_last_lastmonth_mean'], $d['res_last_lastmonth_mean_lt']);
      $a4 = get_col_table_watertemp($d['res_last_month_mean'], $d['res_last_month_mean_lt']);
      $a5 = get_col_table_watertemp($d['res_this_year_mean'], $d['res_this_year_mean_lt']);
      $a6 = get_col_table_watertemp($d['res_last_year_mean'], $d['res_last_year_mean_lt']);
    ...
    <tr>
      ...
      <td style="background-color: <?= esc($a1[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a1[2] != "") { echo $a1[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a1[3]); ?>"/></svg></td>
      <td style="background-color: <?= esc($a2[0]); ?>;"><?php if ($a2[2] != "") { echo $a2[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a2[3]); ?>"/></svg></td>
      <td style="background-color: <?= esc($a3[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a3[2] != "") { echo $a3[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a3[3]); ?>"/></svg></td>
      <td style="background-color: <?= esc($a4[0]); ?>;"><?php if ($a4[2] != "") { echo $a4[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a4[3]); ?>"/></svg></td>
      <td style="background-color: <?= esc($a5[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a5[2] != "") { echo $a5[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a5[3]); ?>"/></svg></td>
      <td style="background-color: <?= esc($a6[0]); ?>;"><?php if ($a6[2] != "") { echo $a6[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a6[3]); ?>"/></svg></td>
    </tr>
    <?php endforeach; ?>
</table>
</div>
...
var basin_last_day = L.tileLayer.wms('<?php echo $geoserver_wms_url; ?>&env=analysis:res_last_day;analysis_str:res_last_day_string', {
  layers: 'hydrodash:mv_watertemp_basins',
  opacity: 1,
  transparent: true,
  format: 'image/png',
  attribution: "", 
...
$.ajax('<?php echo $geoserver_wfs_url; ?>',{
  ...
  data: {
    ...
    version: '1.1.0',
    request: 'GetFeature',
    typename: 'hydrodash:mv_watertemp',
    srsname: 'EPSG:4326',
...
function handleJsonHydroDash(data) {
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt);
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt) + "</div>", 
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt);
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt);
  ...
  result_text_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleWatertemp(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt);
  ...
  result_text_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextWatertemp(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
...
var legend = L.control({ position: "bottomleft" })
  ...
  div.innerHTML += '<i style="background: rgba(171,217,233,1)"></i><span>-3 - -1.5</span><br>';
  div.innerHTML += '<i style="background: rgba(224,243,248,1)"></i><span>-1.5 - 0</span><br>';
  div.innerHTML += '<i style="background: rgba(255,255,255,1)"></i><span>0</span><br>';
  div.innerHTML += '<i style="background: rgba(254,224,144,1)"></i><span>0 - +1.5</span><br>';
  div.innerHTML += '<i style="background: rgba(253,174,97,1)"></i><span>+1.5 - +3</span><br>';
  div.innerHTML += '<i style="background: rgba(244,109,67,1)"></i><span>+3 - +4.5</span><br>';
  div.innerHTML += '<i style="background: rgba(215,48,39,1)"></i><span>>= +4.5</span><br>';
return div; };
...
function setAnalysis(id) {
  ...
  if (id == 'cat_1') {
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung Gestern <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Tagesmittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung 30-Tage <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung " + monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear() + " <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Wassertemperatur des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung " + monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear() +  " <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Wassertemperatur des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung Heuer <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Wassertemperatur von 01.01." + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Wassertemperatur - Abweichung Vorjahr <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Wassertemperatur des Jahres " + 
