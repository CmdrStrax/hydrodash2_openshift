  ...
  <table class="table table-hover nowrap" id="stations">
    <thead>
      <tr>
        ...
        <th data-priority="3" width="10%">Tagesmittel <small class="text-secondary">[l/s]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($yesterday); ?></small></th>
    ...
    <?php foreach ($ds as $d): ?>
    <?php 
      $a1 = get_col_table_springs($d['res_last_day_mean'], $d['res_last_day_mean_lt']);
      $a2 = get_col_table_springs($d['res_last_30days_mean'], $d['res_last_30days_mean_lt']);
      $a3 = get_col_table_springs($d['res_last_lastmonth_mean'], $d['res_last_lastmonth_mean_lt']);
      $a4 = get_col_table_springs($d['res_last_month_mean'], $d['res_last_month_mean_lt']);
      $a5 = get_col_table_springs($d['res_this_year_mean'], $d['res_this_year_mean_lt']);
      $a6 = get_col_table_springs($d['res_last_year_mean'], $d['res_last_year_mean_lt']);
    ...
    <tr>
      ...
      <td style="border-left: #ccc 1px solid;"><?php if (!is_null($d['res_last_day_mean'])) { echo get_q_round($d['res_last_day_mean']) . ' l/s<br /><small class="text-secondary">(' . (new DateTime($d['res_last_day_mean_to']))->modify('-12 hour')->format('d.m.Y') . ')</small>'; } else { echo "<span class=\"text-secondary fst-italic\">Kein Messwert</span>"; } ?></td>
...
var basin_last_day = L.tileLayer.wms('<?php echo $geoserver_wms_url; ?>&env=analysis:res_last_day;analysis_str:res_last_day_string', {
  layers: 'hydrodash:mv_springs_basins',
  opacity: 1,
  transparent: true,
  format: 'image/png',
  attribution: "", 
...
function setAnalysis(id) {
  ...
  if (id == 'cat_1') {
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung Gestern <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Tagesmittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung 30-Tage <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung " + monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear() + " <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Schüttung des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung " + monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear() +  " <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Schüttung des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung Heuer <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Schüttung von 01.01." + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Schüttung - Abweichung Vorjahr <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Schüttung des Jahres " + 
...
function createChart(id, div_postfix){
  ...
  '<div class="h-100" style="text-align: center;">\
    <b style="color: red">-</b> Schüttung Tagesmittel Heuer [l/s] <span style="color: grey">|</span> <b style="color: #f99090">-</b> Schüttung Tagesmittel Vorjahr [l/s] <span style="color: grey">|</span> <span style="color: #00abe3">=</span> Langjährige Periode<br />\
    ' + lt + '\
    </div>\
