...
<div class="flex-fill w-100 content">
  <div class="container-fluid mt-3 mb-3">
    <div class="card bg-light justify-content-center mb-4 me-2 ms-2">
      <div class="card-body"><b class="card-title m-auto" style="font-size: 1.2em">Station <?php echo $info["name"]; ?> / <?php echo $info["stream"]; ?></b><br />
      ...
      <div class="row">
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a1[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a1[6]) ?>;">Tagesmittel <?php if ($a1['val'] != '') { echo '&#8709; ' . get_q_round($a1['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a1['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a2[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a2[6]) ?>;">Aktuell <?php if ($a2['val'] != '') { echo '&#8709; ' . get_q_round($a2['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a2['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a3[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a3[6]) ?>;">Aktuell <?php if ($a3['val'] != '') { echo '&#8709; ' . get_q_round($a3['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a3['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a4[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a4[6]) ?>;">Aktuell <?php if ($a4['val'] != '') { echo '&#8709; ' . get_q_round($a4['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a4['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a5[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a5[6]) ?>;">Aktuell <?php if ($a5['val'] != '') { echo '&#8709; ' . get_q_round($a5['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a5['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a6[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a6[6]) ?>;">Aktuell <?php if ($a6['val'] != '') { echo '&#8709; ' . get_q_round($a6['val']) . ' m³/s'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(get_q_round($a6['val_lt'])) ?> m³/s<br />
        ...
        <div class="col-lg">
          <div class="card mt-4">
            ...
            <div class="card-body" style="min-height: 450px;">
              ...
              <div class="text-secondary small fst-italic" style="margin-left: 5px;">Kennwerte [m³/s]</div>
              <div class="table-responsive mt-2">
              <table class="table table-condensed table-hover">
                <tr><th width="50">MJNQ</th><th width="50">MQ</th><th width="50">HQ1</th><th width="50">HQ5</th><th width="50">HQ10</th><th width="50">HQ30</th><th width="50">HQ100</th><th width="50">RHHQ</th></tr>
                <tr><td><?= esc(get_q_round($kenn['mjnq'])) ?></td><td><?= esc(get_q_round($kenn['mq'])) ?></td><td><?= esc(get_q_round($kenn['hq1'])) ?></td><td><?= esc(get_q_round($kenn['hq5'])) ?></td><td><?= esc(get_q_round($kenn['hq10'])) ?></td><td><?= esc(get_q_round($kenn['hq30'])) ?></td><td><?= esc(get_q_round($kenn['hq100'])) ?></td><td><?= esc(get_q_round($kenn['rhhq'])) ?></td></tr>
              </table>
              </div>
            </div>
          </div>
...
<script>
  ...
  let ts;
  let chartdata = Array();
  var url = '<?php echo base_url();?>discharge/chart/<?= esc($ds_id) ?>';
