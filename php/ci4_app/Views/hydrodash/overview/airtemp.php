  ...
  <table class="table table-hover nowrap" id="stations">
    <thead>
      <tr>
        ...
        <th data-priority="3" width="10%">Tagesmittel <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($yesterday); ?></small></th>
        <th data-priority="2" width="10%">Gestern <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($yesterday); ?></small></th>
        <th data-priority="2" width="10%">Letzte 30 Tage <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;">ab <?= esc($last_30days_from); ?></small></th>
        <th data-priority="2" width="10%">Vor-Vormonat <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_lastmonth); ?></small></th>
        <th data-priority="2" width="10%">Vormonat <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_month); ?></small></th>
        <th data-priority="1" width="10%">Heuer <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;">bis <?= esc($this_year); ?></small></th>
        <th data-priority="2" width="10%">Vorjahr <small class="text-secondary">[°C]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_year); ?></small></th>
      </tr>
    </thead>
    <?php $last_fg = ""; ?>
    <?php foreach ($ds as $d): ?>
    <?php 
      $a1 = get_col_table_airtemp($d['res_last_day_mean'], $d['res_last_day_mean_lt']);
      $a2 = get_col_table_airtemp($d['res_last_30days_mean'], $d['res_last_30days_mean_lt']);
      $a3 = get_col_table_airtemp($d['res_last_lastmonth_mean'], $d['res_last_lastmonth_mean_lt']);
      $a4 = get_col_table_airtemp($d['res_last_month_mean'], $d['res_last_month_mean_lt']);
      $a5 = get_col_table_airtemp($d['res_this_year_mean'], $d['res_this_year_mean_lt']);
      $a6 = get_col_table_airtemp($d['res_last_year_mean'], $d['res_last_year_mean_lt']);
    ...
    <tr>
      ...
      <td style="border-left: #ccc 1px solid;"><?php if (!is_null($d['res_last_day_mean'])) { echo round($d['res_last_day_mean'], 1) . ' °C<br /><small class="text-secondary">(' . (new DateTime($d['res_last_day_mean_to']))->modify('-12 hour')->format('d.m.Y') . ')</small>'; } else { echo "<span class=\"text-secondary fst-italic\">Kein Messwert</span>"; } ?></td>
      <td style="background-color: <?= esc($a1[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a1[2] != "") { echo $a1[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a1[3]); ?>"/></svg><br /></td>
      <td style="background-color: <?= esc($a2[0]); ?>;"><?php if ($a2[2] != "") { echo $a2[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a2[3]); ?>"/></svg><br /></td>
      <td style="background-color: <?= esc($a3[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a3[2] != "") { echo $a3[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a3[3]); ?>"/></svg><br /></td>
      <td style="background-color: <?= esc($a4[0]); ?>;"><?php if ($a4[2] != "") { echo $a4[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a4[3]); ?>"/></svg><br /></td>
      <td style="background-color: <?= esc($a5[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a5[2] != "") { echo $a5[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a5[3]); ?>"/></svg><br /></td>
      <td style="background-color: <?= esc($a6[0]); ?>;"><?php if ($a6[2] != "") { echo $a6[2]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a6[3]); ?>"/></svg><br /></td>
    </tr>
    <?php endforeach; ?>
</table>
</div>
...
var overview_basin_div = L.divIcon({
  ...
  "html": "<i style=\"font-size: 14px;\">Gesamt:</i><br /><b><?php echo append_sign($basins['res_this_year'], 1, '°C'); ?></b>", 
  "iconSize": [120, 60],
});
...
var basin_last_day = L.tileLayer.wms('<?php echo $geoserver_wms_url; ?>&env=analysis:res_last_day;analysis_str:res_last_day_string', {
  layers: 'hydrodash:mv_airtemp_basins',
  opacity: 1,
  transparent: true,
  format: 'image/png',
  attribution: "", 
...
function handleJsonHydroDash(data) {
  ...
  if (data.features.length > 0) {
    d_a1_1 = new Date(data.features[0].properties.res_last_day_mean_from);
    d_a1_2 = new Date(data.features[0].properties.res_last_day_mean_to);

    d_a2_1 = new Date(data.features[0].properties.res_last_30days_mean_from);
    d_a2_2 = new Date(data.features[0].properties.res_last_30days_mean_to);

    d_a3_1 = new Date(data.features[0].properties.res_last_lastmonth_mean_from);
    d_a3_2 = new Date(data.features[0].properties.res_last_lastmonth_mean_to);

    d_a4_1 = new Date(data.features[0].properties.res_last_month_mean_from);
    d_a4_2 = new Date(data.features[0].properties.res_last_month_mean_to);

    d_a5_1 = new Date(data.features[0].properties.res_this_year_mean_from);
    d_a5_2 = new Date(data.features[0].properties.res_this_year_mean_to);

    d_a6_1 = new Date(data.features[0].properties.res_last_year_mean_from);
    d_a6_2 = new Date(data.features[0].properties.res_last_year_mean_to);
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt);
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt) + "</div>", 
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt);
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt);
  ...
  result_text_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPointStyleAirtemp(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt);
  ...
  result_text_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getTextAirtemp(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
...
var legend = L.control({ position: "bottomleft" })
  ...
  div.innerHTML += '<i style="background: rgba(69,117,180,1)"></i><span>< -6</span><br>';
  div.innerHTML += '<i style="background: rgba(116,173,209,1)"></i><span>-6 - -4</span><br>';
  div.innerHTML += '<i style="background: rgba(171,217,233,1)"></i><span>-4 - -2</span><br>';
  div.innerHTML += '<i style="background: rgba(224,243,248,1)"></i><span>-2 - 0</span><br>';
  div.innerHTML += '<i style="background: rgba(255,255,255,1)"></i><span>0</span><br>';
  div.innerHTML += '<i style="background: rgba(254,224,144,1)"></i><span>0 - +2</span><br>';
  div.innerHTML += '<i style="background: rgba(253,174,97,1)"></i><span>+2 - +4</span><br>';
  div.innerHTML += '<i style="background: rgba(244,109,67,1)"></i><span>+4 - +6</span><br>';
  div.innerHTML += '<i style="background: rgba(215,48,39,1)"></i><span>>= +6</span><br>';
return div; };
...
function setAnalysis(id) {
  ...
  if (id == 'cat_1') {
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung Gestern <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Tagesmittel vom " + 
    ...
    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung Gestern <small>[°C]</small></b><br /><small class=\"text-secondary\" style=\"margin-left: 5px;\">(" + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung 30-Tage <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittel vom " + 
    ...
    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung 30-Tage <small>[°C]</small></b><br /><small class=\"text-secondary\" style=\"margin-left: 5px;\">(ab " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung " + monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear() + " <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Lufttemperatur des Monats " + 
      monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear() + " im Vergleich zu " + monthNames[d_a3_1.getMonth()] + " des langjährigen Mittels)</small>"; 

    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung " + monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear().toString().substr(-2) + " <small>[°C]</small></b>"; 
  } else if (id == 'cat_4') {
    map.removeLayer(fg_res_y);
    map.removeLayer(fg_res_l30d);
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung " + monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear() +  " <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Lufttemperatur des Monats " + 
      monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear() + " im Vergleich zu " + monthNames[d_a4_1.getMonth()] + " des langjährigen Mittels)</small>"; 
  
    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung " + monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear().toString().substr(-2) + " <small>[°C]</small></b>"; 
  } else if (id == 'cat_5') {
    map.removeLayer(fg_res_y);
    map.removeLayer(fg_res_l30d);
    map.removeLayer(fg_res_lm);
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung Heuer <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Lufttemperatur von 01.01." + 
    ...
    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung Heuer <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\"><br />(bis " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Lufttemperatur - Abweichung Vorjahr <small>[°C]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Lufttemperatur des Jahres " + 
      (d_a6_1.getFullYear()) + " im Vergleich zum langjährigen Mittel)</small>";
      
    document.getElementById('map_title_mobile').innerHTML = "<b>Abweichung Vorjahr <small>[°C]</small></b><br /><small class=\"text-secondary\" style=\"margin-left: 5px;\">(" + (d_a6_1.getFullYear()) +")</small>";
  }
}
...
function setBasins(chk) {
  ...
  if (cat == "cat_1") {
    ...
    res_carinthia = "<?php echo append_sign($basins['res_last_day'], 1, '°C'); ?>";
  } else if (cat == "cat_2") {
    map.addLayer(basin_last_30days);
    map.removeLayer(carinthia);
    res_carinthia = "<?php echo append_sign($basins['res_last_30days'], 1, '°C'); ?>";
  } else if (cat == "cat_3") {
    map.addLayer(basin_last_lastmonth);
    map.removeLayer(carinthia);
    res_carinthia = "<?php echo append_sign($basins['res_last_lastmonth'], 1, '°C'); ?>";
  } else if (cat == "cat_4") {
    map.addLayer(basin_last_month);
    map.removeLayer(carinthia);
    res_carinthia = "<?php echo append_sign($basins['res_last_month'], 1, '°C'); ?>";
  } else if (cat == "cat_5") {
    map.addLayer(basin_this_year);
    map.removeLayer(carinthia);
    res_carinthia = "<?php echo append_sign($basins['res_this_year'], 1, '°C'); ?>";
  } else if (cat == "cat_6") {
    map.addLayer(basin_last_year);
    map.removeLayer(carinthia);
    res_carinthia = "<?php echo append_sign($basins['res_last_year'], 1, '°C'); ?>";
  }
...
function createChart(id, div_postfix){
  ...
  '<div class="h-100" style="text-align: center;">\
    <b style="color: red">-</b> Lufttemperatur Tagesmittel Heuer [°C] <span style="color: grey">|</span> <b style="color: #f99090">-</b> Lufttemperatur Tagesmittel Vorjahr [°C] <span style="color: grey">|</span> <span style="color: #00abe3">=</span> Langjährige Periode<br />\
    ' + lt + '\
    </div>\
