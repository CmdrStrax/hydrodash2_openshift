  ...
  <table class="table table-hover nowrap" id="stations">
    <thead>
      <tr>
        ...
        <th data-priority="3" width="10%">Tagesmittel <small class="text-secondary">[m³/s]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($yesterday); ?></small></th>
    ...
    <?php foreach ($ds as $d): ?>
    <?php 
      $a1 = get_col_table_discharge($d['res_last_day_mean'], $d['res_last_day_mean_lt']);
      $a2 = get_col_table_discharge($d['res_last_30days_mean'], $d['res_last_30days_mean_lt']);
      $a3 = get_col_table_discharge($d['res_last_lastmonth_mean'], $d['res_last_lastmonth_mean_lt']);
      $a4 = get_col_table_discharge($d['res_last_month_mean'], $d['res_last_month_mean_lt']);
      $a5 = get_col_table_discharge($d['res_this_year_mean'], $d['res_this_year_mean_lt']);
      $a6 = get_col_table_discharge($d['res_last_year_mean'], $d['res_last_year_mean_lt']);
    ...
    ?>
    <tr>
      <td><a href="<?php echo base_url(); ?><?php echo $sub; ?>/<?php echo $d['id'] ?>"><?php echo $d['name'] ?> / <?php echo $d['stream'] ?></a></td>
      <td style="display:none;"><?php echo $d['catchment_name'] ?></td>
      <td style="border-left: #ccc 1px solid;"><?php if (!is_null($d['res_last_day_mean'])) { echo get_q_round($d['res_last_day_mean']) . ' m³/s<br /><small class="text-secondary">(' . (new DateTime($d['res_last_day_mean_to']))->modify('-12 hour')->format('d.m.Y') . ')</small>'; } else { echo "<span class=\"text-secondary fst-italic\">Kein Messwert</span>"; } ?></td>
...
var basin_last_day = L.tileLayer.wms('<?php echo $geoserver_wms_url; ?>&env=analysis:res_last_day;analysis_str:res_last_day_string', {
  layers: 'hydrodash:mv_discharge_basins',
  opacity: 1,
  transparent: true,
  format: 'image/png',
  attribution: "", 
...
var fg_res_y = L.featureGroup({ pane: 'vect' }).addTo(map);
var fg_res_l30d = L.featureGroup({ pane: 'vect' }).addTo(map);
var fg_res_lm = L.featureGroup({ pane: 'vect' }).addTo(map);
var fg_res_lm2 = L.featureGroup({ pane: 'vect' }).addTo(map);
var fg_res_ty = L.featureGroup({ pane: 'vect' }).addTo(map);
var fg_res_ly = L.featureGroup({ pane: 'vect' }).addTo(map);
...
$.ajax('<?php echo $geoserver_wfs_url; ?>',{
  ...
  data: {
    ...
    version: '1.1.0',
    request: 'GetFeature',
    typename: 'hydrodash:mv_discharge',
    srsname: 'EPSG:4326',
...
function handleJsonHydroDash(data) {
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt);
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup('<b>Station ' + feature.properties.name + ' / ' + feature.properties.stream + '</b> <small class="text-secondary">(' + feature.properties.hzbnr + ')</small>' +
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_day_mean, feature.properties.res_last_day_mean_lt) + "</div>", 
  ...
  result_points_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt);
  ...
  result_text_y = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_30days_mean, feature.properties.res_last_30days_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_month_mean, feature.properties.res_last_month_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_lastmonth_mean, feature.properties.res_last_lastmonth_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt);
  ...
  result_text_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_this_year_mean, feature.properties.res_this_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt);
  ...
  result_text_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_year_mean, feature.properties.res_last_year_mean_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
...
function setAnalysis(id) {
  ...
  if (id == 'cat_1') {
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung Gestern <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Tagesmittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung 30-Tage <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittel vom " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung " + monthNames[d_a3_1.getMonth()] + ' ' + d_a3_1.getFullYear() + " <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Abfluss des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung " + monthNames[d_a4_1.getMonth()] + ' ' + d_a4_1.getFullYear() +  " <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Abfluss des Monats " + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung Heuer <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Abfluss von 01.01." + 
    ...
    document.getElementById('map_title').innerHTML = "<b>Abfluss - Abweichung Vorjahr <small>[%]</small></b> <small class=\"text-secondary\" style=\"margin-left: 5px;\">(Mittlerer Abfluss des Jahres " + 
...
function createChart(id, div_postfix){
  ...
  '<div class="h-100" style="text-align: center;">\
    <b style="color: red">-</b> Abfluss Tagesmittel Heuer [m³/s] <span style="color: grey">|</span> <b style="color: #f99090">-</b> Abfluss Tagesmittel Vorjahr [m³/s] <span style="color: grey">|</span> <span style="color: #00abe3">=</span> Langjährige Periode<br />\
    ' + lt + '\
    </div>\
