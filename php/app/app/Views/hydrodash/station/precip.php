...
$my_a1 = get_col_station_precip($a1["val"], $a1["val_lt"], $a1["from"], $a1["to"]); 
$my_a2 = get_col_station_precip($a2["val"], $a2["val_lt"], $a2["from"], $a2["to"]); 
$my_a3 = get_col_station_precip($a3["val"], $a3["val_lt"], $a3["from"], $a3["to"]); 
$my_a4 = get_col_station_precip($a4["val"], $a4["val_lt"], $a4["from"], $a4["to"]); 
$my_a5 = get_col_station_precip($a5["val"], $a5["val_lt"], $a5["from"], $a5["to"]); 
?>
      ...
      <div class="row">
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a1[0]) ?>; padding: 15px; text-align: center;">
            ...
            <?= esc($my_a1[2]) ?> - <?= esc($my_a1[3]) ?></p>
            <p style="margin-bottom: 5px;"><b style="color: <?= esc($my_a1[5]) ?>"><?php echo $my_a1[1]; ?></b></p>
            <small style="color: <?= esc($my_a1[6]) ?>;">Aktuell <?php if ($a1['val'] != '') { echo '&#8709; ' . round($a1['val']) . ' mm'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(round($a1['val_lt'])) ?> mm<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a2[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a2[6]) ?>;">Aktuell <?php if ($a2['val'] != '') { echo '&#8709; ' . round($a2['val']) . ' mm'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(round($a2['val_lt'])) ?> mm<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a3[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a3[6]) ?>;">Aktuell <?php if ($a3['val'] != '') { echo '&#8709; ' . round($a3['val']) . ' mm'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(round($a3['val_lt'])) ?> mm<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a4[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a4[6]) ?>;">Aktuell <?php if ($a4['val'] != '') { echo '&#8709; ' . round($a4['val']) . ' mm'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(round($a4['val_lt'])) ?> mm<br />
        ...
        <div class="col-md">
          <div class="mb-3" style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: <?= esc($my_a5[0]) ?>; padding: 15px; text-align: center;">
            ...
            <small style="color: <?= esc($my_a5[6]) ?>;">Aktuell <?php if ($a5['val'] != '') { echo '&#8709; ' . round($a5['val']) . ' mm'; } else { echo '-'; } ?><br />
            Langjährig &#8709; <?= esc(round($a5['val_lt'])) ?> mm<br />
...
<script>
  ...
  let ts;
  let chartdata = Array();
  var url = '<?php echo base_url();?>precip/chart/<?= esc($ds_id) ?>';
