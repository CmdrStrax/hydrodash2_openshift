...
<div class="container-fluid mt-3 mb-3">
  <table class="table table-hover nowrap" id="stations">
    <thead>
      <tr>
        <th data-priority="1" width="31%">Stationsname</th>
        <th data-priority="10" style="display:none;">Flussgebiet</th>
        <th data-priority="3" width="11.5%">Niederschlag heuer <small class="text-secondary">[mm]</small><br /><small class="text-secondary" style="font-weight: normal !important;">bis <?= esc($this_year); ?></small></th>
        <th data-priority="2" width="11.5%">Letzte 30 Tage <small class="text-secondary">[%]</small><br /><small class="text-secondary" style="font-weight: normal !important;">ab <?= esc($last_30days_from); ?></small></th>
        <th data-priority="2" width="11.5%">Vor-Vormonat <small class="text-secondary">[%]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_lastmonth); ?></small></th>
        <th data-priority="2" width="11.5%">Vormonat <small class="text-secondary">[%]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_month); ?></small></th>
        <th data-priority="1" width="11.5%">Heuer <small class="text-secondary">[%]</small><br /><small class="text-secondary" style="font-weight: normal !important;">bis <?= esc($this_year); ?></small></th>
        <th data-priority="2" width="11.5%">Vorjahr <small class="text-secondary">[%]</small><br /><small class="text-secondary" style="font-weight: normal !important;"><?= esc($last_year); ?></small></th>
      </tr>
    </thead>
    <?php $last_fg = ""; ?>
    <?php foreach ($ds as $d): ?>
    <?php 
      $a1 = get_col_table_precip($d['res_last_30days'], $d['res_last_30days_lt']);
      $a2 = get_col_table_precip($d['res_last_lastmonth'], $d['res_last_lastmonth_lt']);
      $a3 = get_col_table_precip($d['res_last_month'], $d['res_last_month_lt']);
      $a4 = get_col_table_precip($d['res_this_year'], $d['res_this_year_lt']);
      $a5 = get_col_table_precip($d['res_last_year'], $d['res_last_year_lt']);
    ...
    <tr>
      ...
      <td style="border-left: #ccc 1px solid;"><?php if (!is_null($d['res_this_year'])) { echo round($d['res_this_year']) . ' mm<br /><small class="text-secondary">(bis ' . (new DateTime($d['res_this_year_to']))->format('d.m.Y') . ')</small>'; } else { echo "<span class=\"text-secondary fst-italic\">Kein Messwert</span>"; } ?></td>
      ...
      <td style="background-color: <?= esc($a3[0]); ?>;"><?php if ($a3[1] != "") { echo $a3[1]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a3[3]); ?>"/></svg><br /><small class="text-secondary"><?php if ($a3[2] != "") { echo '(' . $a3[2] . ')'; } ?></small></td>
      <td style="background-color: <?= esc($a4[0]); ?>; border-left: #ccc 1px solid;"><?php if ($a4[1] != "") { echo $a4[1]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a4[3]); ?>"/></svg><br /><small class="text-secondary"><?php if ($a4[2] != "") { echo '(' . $a4[2] . ')'; } ?></small></td>
      <td style="background-color: <?= esc($a5[0]); ?>;"><?php if ($a5[1] != "") { echo $a5[1]; } else { echo '<span class="text-secondary fst-italic">Kein Messwert ' . $tooltip . '<br /></span>'; } ?><svg class="ms-1" width="16" height="16" fill="#777"><use xlink:href="#<?= esc($a5[3]); ?>"/></svg><br /><small class="text-secondary"><?php if ($a5[2] != "") { echo '(' . $a5[2] . ')'; } ?></small></td>
    </tr>
    <?php endforeach; ?>
</table>
</div>
...
var basin_last_30days = L.tileLayer.wms('<?php echo $geoserver_wms_url; ?>&env=analysis:res_last_30days;analysis_str:res_last_30days_string', {
  layers: 'hydrodash:mv_precip_basins',
  opacity: 1,
  transparent: true,
  format: 'image/png',
  attribution: "", 
...
function handleJsonHydroDash(data) {
  ...
  if (data.features.length > 0) {
    d_a1_1 = new Date(data.features[0].properties.res_last_30days_from);
    d_a1_2 = new Date(data.features[0].properties.res_last_30days_to);

    d_a2_1 = new Date(data.features[0].properties.res_last_lastmonth_from);
    d_a2_2 = new Date(data.features[0].properties.res_last_lastmonth_to);

    d_a3_1 = new Date(data.features[0].properties.res_last_month_from);
    d_a3_2 = new Date(data.features[0].properties.res_last_month_to);

    d_a4_1 = new Date(data.features[0].properties.res_this_year_from);
    d_a4_2 = new Date(data.features[0].properties.res_this_year_to);

    d_a5_1 = new Date(data.features[0].properties.res_last_year_from);
    d_a5_2 = new Date(data.features[0].properties.res_last_year_to);
    ...
    if (!mobileCheck()) {
      var radioHtml =  
        ...
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 12px; margin-top: 5px;" for="cat_1">Letzte 30 Tage</label>' + 
        '<input type="radio" class="btn-check" name="cat" id="cat_2" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 12px; margin-top: 5px;" for="cat_2">' + monthNames[d_a2_1.getMonth()] + ' ' + d_a2_1.getFullYear() + '</label>' +
        '<input type="radio" class="btn-check" name="cat" id="cat_3" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_3">' + monthNames[d_a3_1.getMonth()] +' ' + d_a3_1.getFullYear() + '</label>' +
        '<input type="radio" class="btn-check" name="cat" id="cat_4" autocomplete="off" checked onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 12px; margin-top: 5px;" for="cat_4">Heuer</label>' + 
        '<input type="radio" class="btn-check" name="cat" id="cat_5" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_5">Vorjahr</label>' + 
        '</div>';
    } else {
      ...
      var radioHtml = 
        ...
        '<label class="btn btn-outline-success btn-sm" style="margin-left: 5px; margin-top: 5px;" for="basin_overlay"">Gebietswerte</label>' + 
        '<input type="radio" class="btn-check" name="cat" id="cat_1" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_1">Letzte 30 Tage</label>' + 
        '<input type="radio" class="btn-check" name="cat" id="cat_2" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_2">' + monthNamesShort[d_a2_1.getMonth()] + '. ' + d_a2_1.getFullYear().toString().substr(-2) + '</label>' +
        '<input type="radio" class="btn-check" name="cat" id="cat_3" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        ...
        '<input type="radio" class="btn-check" name="cat" id="cat_4" autocomplete="off" checked onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_4">Heuer</label>' + 
        '<input type="radio" class="btn-check" name="cat" id="cat_5" autocomplete="off" onclick="setAnalysis(this.id);">' + 
        '<label class="btn btn-outline-primary btn-sm" style="margin-left: 5px; margin-top: 5px;" for="cat_5">Vorjahr</label>' + 
        '</div>';
    }
  ...
  result_points_l30d = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_30days, feature.properties.res_last_30days_lt);
  ...
  result_text_l30d = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_30days, feature.properties.res_last_30days_lt) + "</div>", 
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_month, feature.properties.res_last_month_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_month, feature.properties.res_last_month_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_lastmonth, feature.properties.res_last_lastmonth_lt);
  ...
  result_text_lm = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_lastmonth, feature.properties.res_last_lastmonth_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_this_year, feature.properties.res_this_year_lt);
  ...
  result_text_ty = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_this_year, feature.properties.res_this_year_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
  ...
  result_points_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        style = getPercentPointStyle(feature.properties.res_last_year, feature.properties.res_last_year_lt);
  ...
  result_text_ly = L.geoJson(data, {
    pointToLayer: (feature, latlng) => {
        return new L.marker([feature.geometry.coordinates[1], feature.geometry.coordinates[0]], {
          icon: new L.DivIcon({
            "className": "empty", 
            "html": "<div style=\"font-family: var(--bs-font-sans-serif); font-size: 10pt; color: #222; clear:both; text-align: center;\">" + getPercentText(feature.properties.res_last_year, feature.properties.res_last_year_lt) + "</div>", 
            "iconAnchor": [25 + feature.properties.x_offset, 26 + feature.properties.y_offset], 
            "iconSize": [50, 8],
          })
        });
...
function setCounties() {
  ...
  } else if (map.hasLayer(basin_last_30days) ||
  ...
  $.ajax({
      ...
      success: function (data) {
        ...
        '<div class="h-100" style="text-align: center;">\
          <b style="color: red">-</b> Niederschlag Heuer [mm] <span style="color: grey">|</span> <b style="color: #f99090">-</b> Niederschlag Vorjahr [mm] <span style="color: grey">|</span> <span style="color: #00abe3">=</span> Langjährige Periode<br />\
          ' + lt + '\
          </div>\
          <div class="mt-2 small">\
            <div class="row">\
              <div class="col p-1">\
                <div style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: ' + a1[0] + '; text-align: center; padding: 1em;">\
              ...
              <div class="col p-1">\
                <div style="border: 1px solid rgb(199, 199, 199); border-radius: 10px; background-color: ' + a2[0] + '; text-align: center; padding: 1em;">\
                  <b>' + monthNames[d_a2_1.getMonth()] + ' ' + d_a2_1.getFullYear().toString().substr(-2) + '</b><br />\
